  ...
  const plans = [
    {
      ...
      currency: "INR",
      description:
        "The world of code is quiet… but those who master Python shape it. Will you?",
    },
    {
      name: "Full Access",
      amount: 9.99, // USD
    ...
    try {
      ...
      const options = {
        ...
        handler: function (response) {
          ...
          localStorage.setItem("subscribedPython", "true"); // unlock Python content
        },
        theme: { color: "#00cba9" },
      };
            ...
            <div className="sub-body">
              ...
              <ul className="sub-list">
                <li className="sub-item">
                  <span className="check">✔</span> Unlock All Python Lessons
                </li>
                <li className="sub-item">
                  <span className="check">✔</span> Become a Python Pro
                </li>
                <li className="sub-item">
